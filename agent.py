...
class DQN:
    ...
    def __init__(self, input_dim, output_dim, model_name="model_snake"):
    ...
    def pick_action(self, state):
        optimal_action = torch.argmax(self.online_network(state)).item()
        random_action = int(np.random.randint(0, 4))
